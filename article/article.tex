...
\begin{document}
	...
	\todo{Add ABS + full noise}
	\todo{Add ABS without filter}
	\todo{Add ABS with bad filter}
	...
	\todo{Add simulation w base agent, on different curves and different mue}
